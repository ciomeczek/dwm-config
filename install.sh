...
cp $REPO_PATH/Pictures/lain.jpg -r $HOME/Pictures/
cp $REPO_PATH/.oh-my-zsh $REPO_PATH/.xbindkeysrc $REPO_PATH/.zshrc $REPO_PATH/.config $REPO_PATH/.xprofile $REPO_PATH/.local -r $HOME
